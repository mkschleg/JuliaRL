...
get(gvfh::Horde, action_t, state_tp1, preds_tp1) =
    get(gvfh::Horde, nothing, action_t, state_tp1, nothing, preds_tp1)

get(gvfh::Horde, state_t, action_t, state_tp1, preds_tp1) =
    get(gvfh::Horde, state_t, action_t, state_tp1, nothing, preds_tp1)

get!(C, Γ, Π_probs, gvfh::Horde, action_t, state_tp1, preds_tp1) =
    get!(C, Γ, Π_probs, gvfh::Horde, nothing, action_t, state_tp1, nothing, preds_tp1)
